  ...
  const NavLinks = ({ onClick = () => {} }) => (
    <nav className="space-y-1">
      ...
      <Link href="/admin/utilizatori" onClick={onClick}>
        <Button
          variant={isActive('/admin/utilizatori') ? 'default' : 'ghost'}
          className="w-full justify-start"
        >
      ...
      <Link href="/admin/grupe" onClick={onClick}>
        <Button
          variant={isActive('/admin/grupe') ? 'default' : 'ghost'}
          className="w-full justify-start"
        >
      ...
      <Link href="/admin/prezenta" onClick={onClick}>
        <Button
          variant={isActive('/admin/prezenta') ? 'default' : 'ghost'}
          className="w-full justify-start"
        >
      ...
      <Link href="/admin/abonamente" onClick={onClick}>
        <Button
          variant={isActive('/admin/abonamente') ? 'default' : 'ghost'}
          className="w-full justify-start"
        >
      ...
      <Link href="/admin/evenimente" onClick={onClick}>
        <Button
          variant={isActive('/admin/evenimente') ? 'default' : 'ghost'}
          className="w-full justify-start"
        >
      ...
      <Link href="/admin/excursii" onClick={onClick}>
        <Button
          variant={isActive('/admin/excursii') ? 'default' : 'ghost'}
          className="w-full justify-start"
        >
      ...
      <Link href="/admin/petreceri" onClick={onClick}>
        <Button
          variant={isActive('/admin/petreceri') ? 'default' : 'ghost'}
          className="w-full justify-start"
        >
