    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-red-50 to-orange-50 p-8 rounded-lg border border-red-200 ">
          <h2 className="text-2xl font-bold mb-6 text-red-900 ">În Pași de Dans - Locația noastră</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-red-900 mb-1">Adresă completă</h3>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-red-900 mb-1">Ne puteți contacta telefonic</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-red-900 mb-1">Telefon</h3>
                  <a
