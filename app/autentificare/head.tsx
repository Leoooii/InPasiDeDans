export default function Head() {
  return (
    <>
      <title>Autentificare | In Pasi de Dans</title>
      <meta
        name="description"
        content="Autentifica-te pentru a accesa contul tau de dansator sau administrator."
      />
      ...
      <meta property="og:title" content="Autentificare | In Pasi de Dans" />
      <meta
