...
export default async function BlogPage() {
  ...
  return (
    <>
      ...
      <DarkPageShell pagina="Blog" url="https://www.inpasidedans.ro/blog">
        {/* HERO */}
        <section className="mt-10 md:mt-16 mb-12 md:mb-20">
          <div className="max-w-5xl mx-auto text-center">
            <DarkEticheta icon={Sparkles}>Articole din lumea dansului</DarkEticheta>
        ...
        {categories.length > 0 && (
          <section className="mb-16 md:mb-20">
            <DarkAntetSectiune titlu="Explorează categoriile" subtitlu="Sari direct la subiectul care te interesează" />
        ...
        {featuredPosts.length > 0 && (
          <section className="mb-16 md:mb-20">
            <DarkAntetSectiune titlu="Articole recomandate" subtitlu="Selecția editorilor — cele mai citite și apreciate" icon={Sparkles} />
        ...
        {/* TOATE ARTICOLELE */}
        <section className="mb-16 md:mb-20">
          <DarkAntetSectiune titlu="Toate articolele" subtitlu="De la cele mai recente, cronologic" />
