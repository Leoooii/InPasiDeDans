...
export default function ContPage() {
  ...
  const fetchPrezente = async (userId: string) => {
    try {
      ...
      showToast('Nu s-au putut încărca prezențele', 'error');
    }
  };
      ...
      <div className="container py-12">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Nu s-au putut încărca datele contului tău
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="container py-12">
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              Mulțumim pentru înregistrare! Contul tău este în curs de aprobare
            ...
            <CardHeader>
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  ...
                  <CardDescription>
                    Istoricul prezențelor tale la cursuri
                  </CardDescription>
                </div>
                ...
                {uniqueGrupe.length > 0 && (
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Button
                        variant={
                          selectedGrupa === 'toate' ? 'default' : 'outline'
                        }
                        size="sm"
                      ...
                      {uniqueGrupe.map(grupa => (
                        <Button
                          key={grupa}
                          variant={
                            selectedGrupa === grupa ? 'default' : 'outline'
                          }
                          size="sm"
        ...
        <TabsContent value="abonamente">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detalii despre abonamentele tale active și expirate
              </CardDescription>
            </CardHeader>
            <CardContent>
              {abonamente.length > 0 ? (
                abonamente.map(abonament => {
                  ...
                  const zileRamase = Math.ceil(
                    (dataExpirare.getTime() - acum.getTime()) /
                      (1000 * 60 * 60 * 24)
                  );
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-2">
                        <p className="text-sm">
                          <span className="font-medium">Ședințe rămase:</span>{' '}
                          {abonament.sedinteRamase} din {abonament.numarSedinte}
                        </p>
                      </div>
                    </div>
                  );
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    ...
                    typeof userData.dataInregistrare.toDate === 'function'
                      ? new Date(
                          userData.dataInregistrare.toDate()
                        ).toLocaleDateString('ro-RO')
                      : 'Data necunoscută'}
                  </p>
                </div>
