    ...
    <div className="container flex items-center justify-center min-h-[calc(100vh-5rem)] py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold">Înregistrare cont nou</CardTitle>
          <CardDescription>Completează formularul pentru a crea un cont nou</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="prenume" value={prenume} onChange={(e) => setPrenume(e.target.value)} required />
              </div>
            </div>
        ...
        <CardFooter className="flex flex-col">
          <div className="text-center mt-2">
            <p>
              Ai deja cont?{" "}
              <Link href="/autentificare" className="text-red-600 hover:underline">
                Autentifică-te
              </Link>
            </p>
          </div>
