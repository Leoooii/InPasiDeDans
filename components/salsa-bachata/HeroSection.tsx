...
export default function HeroSection() {
  return (
    <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-8 md:p-12 text-center shadow-lg border border-red-200 ">
      ...
      <div className="space-y-4 mb-8">
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
          Descoperă <strong className="text-red-600 ">cursuri de salsa și bachata în București</strong>, create pentru <strong className="text-red-600 ">începători și intermediari</strong>. Indiferent dacă vrei să înveți pașii de bază sau să îți perfecționezi tehnica, te așteptăm cu o atmosferă relaxată, prietenoasă și plină de energie.
        </p>
        
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
          <strong className="text-red-600 ">Înscrie-te acum la cursurile noastre de Salsa și Bachata din sector 5 & sector 6 București</strong> și bucură-te de lecții interactive, instructori cu experiență și o comunitate pasionată de dans.
        </p>
      </div>
