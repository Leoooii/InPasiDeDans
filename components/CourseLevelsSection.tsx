    ...
    <div id="structura-niveluri" className="p-0 container flex flex-col gap-8">
      <div className="bg-slate-50 rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100 ">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg md:text-xl text-slate-700 leading-relaxed max-w-4xl mx-auto mt-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-orange-400 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center mb-4">
              ...
              <h4 className="text-xl font-bold text-slate-800">Începători</h4>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-yellow-400 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center mb-4">
              ...
              <h4 className="text-xl font-bold text-slate-800">Intermediari</h4>
            </div>
            <p className="text-slate-600 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-red-400 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center mb-4">
              ...
              <h4 className="text-xl font-bold text-slate-800">Avansați</h4>
            </div>
            <p className="text-slate-600 leading-relaxed">
